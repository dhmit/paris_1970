...
export class PhotoView extends PhotoViewer {
    ...
    render() {
        ...
        if (!this.state.photoData) {
            return (
                <h1>Photo with id {window.location.pathname.split("/")[2]} is not in database.</h1>
            );
        }
        const {
            alt,
        ...
        window.addEventListener("keydown", (e) =>
            e.code === "Escape" ? this.setState({showPhotoModal: false}) : null
        );
            ...
            <div className="page" id="photo-view">
                ...
                <div className="page row">
                    <div className="image-view col-12 col-lg-6 col-md-8">
                        <div
                            className={
                                this.state.displaySide === "slide" ? "image-box slide" : "image-box"
                            }
                        >
                            <div className="map-square-photos-navigation-container">
                                <a
                                    className="map-square-pictures-navigation-arrow"
                                    href={this.state.prevLink}
                                >
                                    <LeftArrow />
                                </a>
                                <p style={{padding: 0, margin: 0}}>
                                    Navigate Images from Map Square #{this.props.mapSqaureNumber}
                                </p>
                                <a
                                    className="map-square-pictures-navigation-arrow"
                        ...
                        <div className={"center-btn mb-4"}>
                            ...
                            <button
                                ...
                                style={{
                                    backgroundColor:
                                        this.state.displaySide === "photo" ? TURQUOISE : "white",
                                }}
                            ...
                            <button
                                ...
                                style={{
                                    backgroundColor:
                                        this.state.displaySide === "slide" ? TURQUOISE : "white",
                                }}
                        ...
                        <div className="similar-photos-header">
                            ...
                            <Dropdown className="photo-sort-dropdown">
                                <Dropdown.Toggle
                                    className="photo-sort-dropdown-button"
                                    align="start"
                                >
                                    Sort By...
                                </Dropdown.Toggle>
                                ...
                                <Dropdown.Menu>
                                    {Object.keys(analyses).map((analysisName, k) => (
                        ...
                        {this.getPhotoSlider(similarPhotos, {
                    ...
                    <div className="image-info col-12 col-lg-6 col-md-4">
                        ...
                        {this.props.photographer_name ? (
                            <>
                                ...
                                <p>
                                    <a
                                        href={`/photographer/${this.props.photographer_number}/`}
                        ...
                        <b>
                            Map Square
                            <span>
                                <a className="photo-link" href={`/map_square/${mapSquareNumber}`}>
                                    {mapSquareNumber}
                                </a>
                            </span>
                            <br />
