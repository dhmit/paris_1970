/*
 NOTE(Ryaan, 2022-8-30): 

    We're not using this anywhere right now, so I'm removing this as live code so I can remove
    d3 as a dependency for this project. Leaving the code here as an example for anyone who
    wants to do this kind of path drawing on our maps. 

    If anyone wants to resuscitate this code, we'll need to add d3 back as a dependency,
    so talk to someone on DH staff first.
*/
