    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_square_obj', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.MapSquare')),
            ],
        ),
        migrations.CreateModel(
            name='Photographer',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Photographer'),
        ),
        migrations.AddField(
